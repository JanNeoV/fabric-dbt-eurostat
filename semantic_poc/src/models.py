...
PBI_DEFINITION_DIR = PROJECT_ROOT / "pbi" / "triathlon_pbi_model.SemanticModel" / "definition"
...
def parse_tmdl_definition(definition_dir: Path = PBI_DEFINITION_DIR, project_root: Path = PROJECT_ROOT) -> dict[str, Any]:
    ...
    return {
        "definition_dir": relative_posix(definition_dir, project_root),
        "tables": tables,
...
def build_snowflake_semantic_view(dbt_semantics: dict[str, Any], environment: dict[str, Any]) -> dict[str, Any]:
